...
class Scheduler:
    ...
    def set_coordinator(self, coordinator, server_id: str):
        """
        Set the coordinator service for distributed scheduling.
        
        Args:
            coordinator: CoordinatorService instance
            server_id: Current server ID
        """
        self._coordinator = coordinator
        self._server_id = server_id
        logger.info(f"Scheduler configured with coordinator, Server ID: {server_id}")
